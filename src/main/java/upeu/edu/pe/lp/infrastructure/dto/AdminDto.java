...
public class AdminDto {
    ...
    public UserEntity userDtoToUser(){
        return new UserEntity(null,this.getEmail(),this.getFirstname(), this.getLastName(),this.getEmail(), this.getAddress(), this.getCellphone(), this.getPassword(), UserType.ADMIN, LocalDateTime.now());
    }
